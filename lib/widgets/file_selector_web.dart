...
class _FileSelectorState extends State<FileSelector> {
  Future<void> _pickFile() async {
    try {
      if (kIsWeb) {
        ...
        uploadInput.accept = '*/*'; // All file types
        uploadInput.click();
  ...
  String _getFileName() {
    ...
    if (kIsWeb) {
      if (widget.selectedFile is html.File) {
        return (widget.selectedFile as html.File).name;
      }
    } else {
      // Handle native file
    }
  ...
  String _getFileSize() {
    ...
    if (kIsWeb) {
      if (widget.selectedFile is html.File) {
        final size = (widget.selectedFile as html.File).size;
  ...
  String _getFileExtension() {
    ...
    if (kIsWeb) {
      if (widget.selectedFile is html.File) {
        final fileName = (widget.selectedFile as html.File).name;
        return fileName.contains('.') ? fileName.split('.').last.toUpperCase() : '';
      }
    } else {
      // Handle native file
    }
  ...
  IconData _getFileIcon() {
    ...
    String ext = _getFileExtension().toLowerCase();
